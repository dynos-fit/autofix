...
try:  # pragma: no cover - exercised only when deps are present
    import tree_sitter as _tree_sitter_mod  # type: ignore[import-not-found]
    ...
    _TS_IMPORT_ERR: ImportError | None = _ts_import_err
else:
    _TS_IMPORT_ERR = None

try:  # pragma: no cover - exercised only when deps are present
    import tree_sitter_python as _tree_sitter_python_mod  # type: ignore[import-not-found]
except ImportError as _tsp_import_err:  # pragma: no cover
    _tree_sitter_python_mod = None  # type: ignore[assignment]
    _TSP_IMPORT_ERR: ImportError | None = _tsp_import_err
else:
    _TSP_IMPORT_ERR = None
