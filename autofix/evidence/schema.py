...
``tests/autofix/test_evidence_builder.py`` enforce this.
"""
...
class CandidateFinding:
    ...
    ``autofix.evidence.fingerprints.compute_finding_fingerprint``.
...
# ``tests/autofix/test_evidence_schema_conformance.py`` enforce the
