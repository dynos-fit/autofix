...
stack from :mod:`autofix.dedup.embedding` — zero new runtime deps.
...
-----------------------------
* ``<root>/.autofix/indexing/embedding.hnswlib.idx``    — binary index.
* ``<root>/.autofix/indexing/embedding-metadata.json``  — schema sidecar.
...
_SIDECAR_DIR: str = ".autofix/indexing"
