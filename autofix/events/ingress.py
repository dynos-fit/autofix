...
:class:`~autofix.events.schema.ScanEvent`. No side effects occur here:
the caller persists the returned event via
:func:`autofix.telemetry.events_log.append_event`. This keeps the
...
def ingest_cli_invocation(
    ...
    *,
    ...
    watcher_confidence:
        ...
        ``"diff-head1"`` (see :func:`autofix.events.change_detector.detect`).
    ...
    ScanEvent
        ...
        :func:`autofix.telemetry.events_log.append_event`.
    """
