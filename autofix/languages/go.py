...
* Implement :meth:`GoAdapter.scip_index` — group the input list of
  ...
  ``<repo_root>/.autofix/state/index/scip-go/<cache-key>.scip``
...
stays self-contained, mirroring :mod:`autofix.languages.jsts`.
"""
...
def _acquire_shard_lock(lock_path: Path):
    ...
    Duplicated from :func:`autofix.languages.jsts._acquire_shard_lock`
...
class GoAdapter:
    ...
    def scip_index(
        ...
        state_dir = repo_root / ".autofix" / "state" / "index" / "scip-go"
        try:
