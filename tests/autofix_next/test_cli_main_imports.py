"""Tests for autofix_next/cli/main.py import safety and subcommand registration.

Covers:
- AC 13 + C-04: import autofix_next.cli.main succeeds with pywatchman patched out;
                import autofix_next.cli.watch_command does NOT trigger pywatchman
                load at module-import time.
- AC 12 + C-05: autofix-next --help exposes exactly 5 subcommands in order:
...
class TestDeferredPywatchmanImport:
    ...
    def test_import_main_succeeds_when_pywatchman_absent(
        ...
        """AC 13: import autofix_next.cli.main succeeds even when pywatchman is
        ...
        import autofix_next.cli.main  # noqa: F401 — import for side-effect check

        # If we get here without ImportError, the test passes
        assert "autofix_next.cli.main" in sys.modules
    ...
    def test_pywatchman_not_in_sys_modules_after_main_import(
        ...
        import autofix_next.cli.main  # noqa: F401
    ...
    def test_import_watch_command_does_not_trigger_pywatchman_load(
        ...
        """C-04: import autofix_next.cli.watch_command does NOT load pywatchman at
        module-import time."""
        ...
        monkeypatch.delitem(sys.modules, "autofix_next.cli.watch_command", raising=False)

        import autofix_next.cli.watch_command  # noqa: F401

        assert "pywatchman" not in sys.modules, (
            "pywatchman was loaded at autofix_next.cli.watch_command module-import "
    ...
    def test_import_watch_command_exports_add_arguments_and_run(self) -> None:
        ...
        from autofix_next.cli.watch_command import add_arguments, run  # noqa: F401

        import autofix_next.cli.watch_command as wc
