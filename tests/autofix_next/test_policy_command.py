"""Tests for autofix_next/cli/policy_command.py (NEW production module).
...
class TestPolicyNoFlag:
    ...
    def test_policy_no_flag_exits_2(
        ...
        from autofix_next.cli.policy_command import add_arguments
...
class TestPolicyShow:
    ...
    def test_show_emits_sorted_json_exits_zero(
        ...
        from autofix_next.cli.policy_command import add_arguments, run
