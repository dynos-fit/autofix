"""Tests for autofix.parsing.tree_sitter.
...
def test_grammar_abi_mismatch_surfaces_tree_sitter_load_error(
    ...
    assert hasattr(ts_mod, "TreeSitterLoadError"), (
        "autofix.parsing.tree_sitter must expose TreeSitterLoadError"
    )
    ...
    assert loader_attr is not None, (
        "autofix.parsing.tree_sitter must expose a patchable language "
