...
def _run_scan_in_subprocess(root: Path) -> int:
    """Run autofix scan in a subprocess so side effects can't leak into
    ...
    bootstrap = (
        ...
        f"sys.argv = ['autofix', 'scan', '--root', {str(root)!r}]\n"
