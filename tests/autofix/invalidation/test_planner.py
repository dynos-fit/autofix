"""Unit tests for the new ``autofix.invalidation.planner``.
...
def test_invalidation_dataclass_shape_frozen() -> None:
    ...
    from autofix.invalidation import planner as planner_mod
    from autofix.invalidation.planner import DEFAULT_CALLER_DEPTH, Invalidation
...
def test_plan_signature_replaces_stub() -> None:
    ...
    from autofix.invalidation.planner import plan
