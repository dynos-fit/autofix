...
prefix .autofix/ does not appear in any source file under autofix/".
"""
...
def test_no_legacy_runtime_path_in_source() -> None:
    ...
    if not PKG_ROOT.is_dir():
        ...
        # `.autofix/` references. Before rename, this test fails because
    ...
    assert not offenders, (
        ".autofix/ path still referenced in:\n  " + "\n  ".join(offenders)
    )
