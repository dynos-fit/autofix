"""Tests for ``autofix.languages.jsts.JSTSAdapter`` (task-006 AC
#12, #13, #14).
...
def _import_jsts():
    return pytest.importorskip("autofix.languages.jsts")
...
def test_jsts_adapter_registered_by_default() -> None:
    ...
    importing ``autofix.languages`` makes it resolvable by
    extension."""
    pytest.importorskip("autofix.languages.jsts")
